...
wp1_f <- tagList(wellPanel( 
  #francais <- paste("Fran&ccedil;ais"),
  actionButton("english", "English", onclick="location.href='https://sdd-business-intelligence.shinyapps.io/CX_Assessment/';", style='padding:10px; background-color: #F0F0F0; font-size:100%; vertical-align: top; color: black; font-weight: bold' ),
    ...
    mainPanel( fluidRow(column( offset = 0, style='padding-top:0px; padding-bottom:50px', width = 12, label = NULL, 
          ...
          ######################################################################     NEW INITIATIVE ##############################################################################                      
                                 ...
                                 conditionalPanel(
                                  ...
                                  width = 12,
                                  actionButton("back1", "Back", onclick="location.href='https://sdd-business-intelligence.shinyapps.io/CX_Assessment/';"), br(),
                                  br(),
          ...
          ###################################################### EXISTING INITIATIVE   ################################################################################################# 
                                ...
                                conditionalPanel(
                                  ...
                                  actionButton("back2_f", "Back", onclick="location.href='https://sdd-business-intelligence.shinyapps.io/CX_Assessment/';"), br(),
                                  width = 12,
                                  br(),
